...
//! on. Video and other binary media are represented as typed stored-file
//! pointers without pretending their bytes were extracted into text.
...
mod tests {
    ...
    #[test]
    fn audio_transcript_redacts_credentials_but_keeps_benign_context() {
        ...
        let out = augment_model_content("see attached".to_string(), &[att]);
