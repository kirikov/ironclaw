...
impl ExtensionPackage {
    ...
    pub fn from_host_bundled_manifest_with_inline_dynamic_schemas(
        ...
        // InstalledLocal (operator-installed volume) providers take the same
        // path as compiled-in host-bundled ones: their catalog is discovered at
        // runtime, so their descriptors carry inline schemas too.
        if !matches!(
            manifest.source,
